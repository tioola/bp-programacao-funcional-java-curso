...
* 07-Paralelização de algoritimos
    + [_-_] _07.1-Como utilizar a paralelização_
...
~~~~~
   ___                _      _ _                          
  / _ \__ _ _ __ __ _| | ___| (_)______ _  ___ __ _  ___  
 / /_)/ _` | '__/ _` | |/ _ \ | |_  / _` |/ __/ _` |/ _ \ 
/ ___/ (_| | | | (_| | |  __/ | |/ / (_| | (_| (_| | (_) |
\/    \__,_|_|  \__,_|_|\___|_|_/___\__,_|\___\__,_|\___/ 
...
* Adaptação com relação aos novos processadores.

# Desvantagens

* Código necessita estar preparado
* Problemas com dependências e códigos legados que não suportam concorrência.
